    ...
    public class FuelCalcController : Controller
    {
        ...
        public async Task<IActionResult> Calculate([FromBody] FuelCalcViewModel model)
        {
            ...
            return Json(new
            {
                ...
                fuelReserveLiters = model.FuelReserveLiters,
                reserveExceedsTank = model.ReserveExceedsTank,
                stints = model.Stints.Select(s => new { s.StintNumber, s.Laps, s.FromLap, s.ToLap, s.Fuel }),
